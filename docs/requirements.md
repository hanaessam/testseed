...
**Dataset versions vs seed batches:** Immutable version history is **planned** (`docs/dataset-version-history.md`). **Today:** saved runs with patch-in-place; seed batch rollback for MongoDB. See `docs/shipped-features.md` for the full inventory.
