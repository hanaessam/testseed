/**
 * Compare .env.production URL settings with Vercel project env presence and API health.
 *
...
try {
  ...
  console.log(`    Could not reach API: ${error instanceof Error ? error.message : String(error)}`);
  process.exit(1);
}
